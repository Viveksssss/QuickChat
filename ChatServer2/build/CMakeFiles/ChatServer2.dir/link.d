ChatServer2: \
  ...
  /usr/lib/gcc/x86_64-pc-linux-gnu/15.2.1/../../../../lib/libmysqlpp.so \
  /usr/lib/libgrpc++.so \
  /usr/lib/libgrpc.so \
  /usr/lib/libgpr.so \
  ...
  /usr/lib/libabsl_random_internal_entropy_pool.so \
  ...
  /usr/lib/libabsl_borrowed_fixup_buffer.so \
  ...
  /usr/lib/libupb_wire_lib.so.53 \
  /usr/lib/libupb_mem_lib.so.53 \
  /usr/lib/ld-linux-x86-64.so.2 \
  /usr/lib32/libsystemd.so.0 \
  /usr/lib/libsystemd.so.0 \
  /usr/lib/libupb_json_lib.so.53 \
  /usr/lib/libupb_textformat_lib.so.53 \
  ...
  /usr/lib/libaddress_sorting.so.53 \
  /usr/lib/libupb_reflection_lib.so.53 \
  /usr/lib/libupb_message_lib.so.53 \
  /usr/lib/libupb_hash_lib.so.53 \
  /usr/lib/libupb_base_lib.so.53 \
  /usr/lib/libutf8_range_lib.so.53 \
  /usr/lib/libupb_mini_table_lib.so.53 \
  /usr/lib/libupb_lex_lib.so.53 \
  /usr/lib/libupb_mini_descriptor_lib.so.53
