/home/vivek/Codes/Qt/StatusServer/StatusServer: \
  ...
  /usr/lib/libupb_wire_lib.so.51 \
  /usr/lib/libupb_mem_lib.so.51 \
  /usr/lib/ld-linux-x86-64.so.2 \
  /usr/lib32/libsystemd.so.0 \
  /usr/lib/libsystemd.so.0 \
  /usr/lib/libupb_json_lib.so.51 \
  /usr/lib/libupb_textformat_lib.so.51 \
  /usr/lib32/libz.so.1 \
  /usr/lib/libz.so.1 \
  ...
  /usr/lib/libaddress_sorting.so.51 \
  /usr/lib/libupb_reflection_lib.so.51 \
  /usr/lib/libupb_message_lib.so.51 \
  /usr/lib/libupb_hash_lib.so.51 \
  /usr/lib/libupb_base_lib.so.51 \
  /usr/lib/libre2.so.11 \
  /usr/lib/libutf8_range_lib.so.51 \
  /usr/lib/libupb_mini_table_lib.so.51 \
  /usr/lib/libupb_lex_lib.so.51 \
  /usr/lib/libupb_mini_descriptor_lib.so.51
